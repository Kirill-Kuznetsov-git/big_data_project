...
missing_vals.write.csv("%s/q1.csv" % csv_dir)
...
print("Day of week\n\n")
avg_trip_time_by_dow.write.csv("%s/q2.csv" % csv_dir)
...
print("Hours\n\n")
avg_trip_time_by_h.write.csv("%s/q3.csv" % csv_dir)
...
print("call type (avg)\n\n")
avg_trip_time_by_call_t.write.csv("%s/q4.csv" % csv_dir)
...
count_trip_time_by_call_t.write.csv("%s/q5.csv" % csv_dir)
...
min_max_avg.show()
print("avg, max, min\n\n")
min_max_avg.write.csv("%s/q6.csv" % csv_dir)

day_type_count = trips.groupBy('day_type').count()
day_type_count.show()
print("day type count\n\n")
day_type_count.write.csv("%s/q7.csv" % csv_dir)
